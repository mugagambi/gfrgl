concrete StructuralMer of Structural = CatMer ** 
  open MorphoMer, ParadigmsMer, DiffMer, 
 ...
 can8know_VV, can_VV = MorphoMer.regV "weza";
 ...
 much_Det, many_Det = { s =\\g =>  Many_prefix g + "ngi" ; n= Pl; isPre =True };
  ...
  most_Predet = {s = \\g => MorphoMer.Mostpredetprefix g + "ngi"} ;
 --  must_VV = {   
  no_Phr = ss "hapana" ;
  no_Utt = ss "hapana" ;
  ...
  part_Prep, possess_Prep = let
       questo : ParadigmsMer.Number =>   MorphoMer.Cgender =>  Str = table {
  ...
  where_IAdv = ss "wapi" ;
  which_IQuant = let
       questo : ParadigmsMer.Number =>  DiffMer.Cgender =>  Str =
        table {
